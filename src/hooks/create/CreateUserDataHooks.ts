import { collection, getDocs, CollectionReference, doc, getDoc, onSnapshot, setDoc, updateDoc, FieldValue, arrayUnion, addDoc } from 'firebase/firestore';
...
export const useCreateUpdateBlog = () => {
  ...
  const createBlog = async (newBlog:BlogModel) => {
    ...
    const blogBody = {...newBlog,id:newBlogId,author:storeState.currentUser.username}
